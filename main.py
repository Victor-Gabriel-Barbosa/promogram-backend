...
async def executar_tempo_real() -> None:
    """Conecta e escuta os grupos em tempo real até a conexão cair.

    Bloqueia indefinidamente (é o próprio loop do Telethon) — quem chamar
    isso a partir da API deve rodá-lo como uma tarefa em background."""
    _validar_configuracao()
    await _conectar_se_necessario()
